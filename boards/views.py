...
# refracting the above code using form module from Django
...
def new_topic(request,pk):
    ...
    if request.method == "POST":
        ...
        if form.is_valid(): #With a bound Form instance, call the is_valid() method to run validation and return a boolean designating whether the data was valid:
