...
urlpatterns = [
    ...
    path('boards/<int:pk>/news',views.new_topic,name='new_topic'),
    ...
    path('reset/<str:uidb64>/<str:token>',PasswordResetConfirmView.as_view(template_name='password_reset_confirm.html'),name='password_reset_confirm'),
